  ...
  <Transition name="modal">
    <div>
      <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        <!-- Conteneur -->
        <div
          class="w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-gray-200 max-h-[92vh] overflow-y-auto">
          ...
          <form @submit.prevent="submit" class="p-6 space-y-6">
            ...
            <div class="flex flex-col w-full">
              ...
              <input v-model="form.title" type="text" placeholder="Entre un titre..."
            ...
            <div class="flex flex-col w-full">
              ...
              <textarea v-model="form.description" rows="4" placeholder="Décris ton idée..."
                class="border border-gray-300 bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"></textarea>
            ...
            <div class="flex flex-col w-full">
              ...
              <div class="space-y-3">
                <div v-for="(tag, index) in form.tags" :key="index" class="flex items-center gap-3">
                  <input v-model="form.tags[index]" type="text" placeholder="Tag..."
              ...
              <button type="button" @click="addTag" class="mt-3 text-blue-600 hover:text-blue-800 font-medium text-sm">
                + Ajouter un tag
              </button>
              ...
              <button type="submit" :disabled="form.processing"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 19l9 2-3-8M5 3l7 6-3 2-2-3z" />
                </svg>
